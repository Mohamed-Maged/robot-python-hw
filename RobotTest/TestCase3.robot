...
TC3_User_could_get_proper_error_if_enter_incorrect_login_or_password
    ${user}=    user object     ${Username}    ${NotValidPassword}      usertest      usertest    usertest@usertest.com
    Log to console  ${user}
